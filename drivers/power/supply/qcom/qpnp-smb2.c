...
/**
 * add by wangyibo at 2017.11.29. As running apk is running and usb is inserted in phone,
 * when battery capacity higher than 80%, stop charging.
 * when battery capacity lower than 40%, system enable recharging.
 * And running apk is stopped, enable charging.
 */
